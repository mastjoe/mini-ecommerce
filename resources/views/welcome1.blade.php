...
<body>
    ...
    <div class="main-wrapper">
                            ...
                            <div class="col-xl-4 col-lg-5">
                                <div class="header-top-right">
                                    <div class="header-login-regi">
                                        <a href="login-register.html"><i class="icon-user"></i> Log In / Register</a>
                                    </div>
        ...
        <div class="slider-area">
            <div class="container">
                <div
                    class="hero-slider-active-1 nav-style-2 dot-style-2 dot-style-2-position-1 dot-style-2-active-black">
                    <div class="single-hero-slider single-animation-wrap slider-height-1 custom-d-flex custom-align-item-center bg-img hm2-slider-bg"
                        style="background-image:url(assets/images/slider/hm-2-slider-1.jpg);">
                        <div class="row">
                            <div class="col-12">
                                <div class="hero-slider-content-2 slider-animated-1">
                                    <h1 class="animated"><span>Basic</span> Color <br>Teen Collection</h1>
                                    <p class="animated">Lorem ipsum dolor sit amet, consectetur adipis elit. Nunc
                                        imperdiet, nulla.</p>
                                    <div class="btn-style-2">
                                        <a class="animated" href="product-details.html">explore now <i
                    ...
                    <div class="single-hero-slider single-animation-wrap slider-height-1 custom-d-flex custom-align-item-center bg-img hm2-slider-bg"
                        style="background-image:url(assets/images/slider/hm-2-slider-2.jpg);">
                        <div class="row">
                            <div class="col-12">
                                <div class="hero-slider-content-2 slider-animated-1">
                                    <h1 class="animated"><span>Basic</span> Color <br>Teen Collection</h1>
                ...
                <div
                    ...
                    <div class="product-plr-1">
                        <div class="single-product-wrap mb-35">
                            ...
                            <div class="product-content-2 text-center">
                                <h3><a href="product-details.html"><span class="blod">Men</span> Clothings <span
                                            class="available-product">(56)</span></a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="product-plr-1">
                        <div class="single-product-wrap mb-35">
                            ...
                            <div class="product-content-2 text-center">
                                <h3><a href="product-details.html"><span class="blod">Women</span> Shoes <span
                                            class="available-product">(55)</span></a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="product-plr-1">
                        <div class="single-product-wrap mb-35">
                            ...
                            <div class="product-content-2 text-center">
                                <h3><a href="product-details.html"><span class="blod">Kid</span> Caps <span
                                            class="available-product">(56)</span></a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="product-plr-1">
                        <div class="single-product-wrap mb-35">
                            ...
                            <div class="product-content-2 text-center">
                                <h3><a href="product-details.html"><span class="blod">Women</span> Accessories <span
                                            class="available-product">(24)</span></a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="product-plr-1">
        ...
        <div class="blog-area pt-115">
            <div class="container">
                <div class="section-title-2 text-center mb-45">
                    <h2><span>Press</span> & Lookbook</h2>
                    <p>Explore the world’s fashon around you, up to date fashion trending and more</p>
                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-wrap mb-30">
                                ...
                                <div class="blog-content">
                                    ...
                                    <h3><a href="blog-details.html">Five things you only know if you’re at Chanel's
                                            Hamburg Show</a></h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-wrap mb-30">
                                ...
                                <div class="blog-content">
                                    ...
                                    <h3><a href="blog-details.html">Calvin Klein Shoes Collection 2020, Activites
                                            Summer</a></h3>
                                </div>
                            </div>
                        </div>
        ...
        <footer class="footer-area pt-85 pb-90">
            <div class="container">
